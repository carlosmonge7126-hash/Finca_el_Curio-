...
import { exigirAdmin } from './_lib/adminAuth.js';
...
export default async function handler(req, res) {
  ...
  // despliegue y cada archivo en /api cuenta como una. Solo el admin
  // puede borrar padrinos, así que exige el token acá.
